    ...
    <div className="mt-[4rem] ">
      <div className="tracking-wide space-y-2">
        ...
        >
          ...
          Node.js. Skilled in automating UI and API testing, developing secure
          systems, and enhancing user interfaces. Recognized for innovative
          solutions and awarded for contributions to software development.
          Strong problem-solving skills with a commitment to delivering scalable
          solutions.
        </p>
      </div>
    </div>
